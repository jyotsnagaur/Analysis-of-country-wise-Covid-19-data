...
Observation from above graph: A residual is a measure of how far away a point is vertically from the regression line. Simply, it is the error between a predicted value and the observed actual value.It follows the highest distribution towards the mean residual length.
