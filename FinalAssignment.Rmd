...
3.  The correlation coefficient is unit-less. The value will stay very similar even with scaling or normalising any of the variables. The coefficient between x and y is same as the correlation coefficient between y and x. 
