...
plot(lmModel)
```
Inference: The data is mostly concentrated and in a scatter formation on the graph. Perhaps it is not so suitable for a linear regression.The fitted line hardly touches some points so will have huge value of error.
