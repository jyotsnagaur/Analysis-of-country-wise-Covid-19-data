...
highest_death_toll <- master_df6[[which.max(master_df6$CumDeaths), "CumDeaths"]]
highest_death_toll
highest_death_date <- master_df6[[which.max(master_df6$CumDeaths), "Date"]]
highest_death_date
```
...
p <- ggplot(master_df7, aes(x = Date)) +
  geom_point(aes(y = Cases_world), colour = "green") +
  geom_line(aes(y = Cases_world), colour = "green") +
  geom_point(aes(y = Deaths_world), colour = "red") +
  geom_line(aes(y = Deaths_world), colour = "red") +
  geom_point(aes(y = Recovered_world), colour = "blue") +
  geom_line(aes(y = Recovered_world), colour = "blue") +
  geom_point(aes(y = Tests_world), colour = "grey") +
